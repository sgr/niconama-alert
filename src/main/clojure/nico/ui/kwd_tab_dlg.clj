...
(ns #^{:author "sgr"
  ...
  (:require [nico.ui.query-panel :as uq]
            ...
            [nico.ui.util :as uu])
  (:import [java.awt Dimension FlowLayout Frame]
           [javax.swing BorderFactory SpringLayout JDialog JLabel JPanel JTextField]
           [javax.swing.event DocumentListener]
           [javax.swing.text PlainDocument]))

(def ^{:private true} ^Dimension DLG-SIZE (Dimension. 450 340))
(def ^{:private true} ^Dimension TITLE-PANEL-SIZE (Dimension. 440 40))
(def ^{:private true} ^Dimension BTN-PANEL-SIZE (Dimension. 440 30))

(defn ^JDialog keyword-tab-dialog
  [^Frame parent ^String title pref ok-fn]
